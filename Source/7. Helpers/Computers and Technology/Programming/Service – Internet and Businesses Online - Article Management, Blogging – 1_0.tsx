...
//BEGIN SERVICES
export default class Software_Programming_Helper_HandleArticleManagement {
    ///////////////////////////////////////////////////////
    //----> Create Methods
    ///////////////////////////////////////////////////////
    async Software_Programming_HandleCreate_SaveArticle()
    {
        try
        {
    ...
    //One Item
    async Software_Programming_HandleRead_GetArticleByID()
    {
        try
        {
            //Step: DEFINE client side validation rules.
    ...
    async Software_Programming_HandleRead_GetArticleCategories()
    {
        try
        {
            //Step: DEFINE client side validation rules.
    ...
    //Multiple Items
    async Software_Programming_HandleRead_GetArticlesAny() {
        try {
            //Step: DEFINE client side validation rules.
    ...
    async Software_Programming_HandleRead_GetArticlesBySearchPhrase() {
        try {
            //Step: DEFINE client side validation rules.
    ...
    //----> Update Methods
    ///////////////////////////////////////////////////////
    async Software_Programming_HandleUpdate_EditArticle() {
        try {
            //Step: DEFINE client side validation rules.
    ...
    //----> Delete Methods
    ///////////////////////////////////////////////////////
    async Software_Programming_HandleDelete_RemoveArticleByID()
    {
        try
        {
            //Step: DEFINE client side validation rules.
